...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-foreground text-left text-xs/relaxed [[data-variant=legend]+&]:-mt-1.5 leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance",
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="text-foreground px-2 bg-background relative mx-auto block w-fit"
