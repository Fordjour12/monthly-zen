...
export default function Planner() {
  ...
  return (
    <Container>
      <View className="mb-3 pt-8">
        <Text className="text-3xl font-bold text-foreground mb-2">Create A Plan</Text>
        <Text className="text-muted-foreground">
          Configure your monthly plan with your goals and preferences.
        </Text>
      </View>
      <View className="flex-row justify-end">
        <Button variant="ghost" onPress={() => router.push("/(tabs)/planner/plans")}>
          <Button.Label>View Recent Plans</Button.Label>
          <HugeiconsIcon icon={ArrowRight01FreeIcons} color={primary} size={20} />
        </Button>
      </View>
