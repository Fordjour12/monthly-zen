...
export default function Home() {
   ...
   const AIPrivateData = useQuery(orpc.AI.privateData.queryOptions());
   ...
   return (
      <Container className="p-6">
         ...
         <Card variant="secondary" className="p-6">
          ...
          <Card variant="secondary" className="mt-6 p-4">
             <Card.Title className="mb-3">AI Private Data</Card.Title>
             {AIPrivateData && (
                <Card.Description>{AIPrivateData.data?.message}</Card.Description>
             )}
          </Card>
